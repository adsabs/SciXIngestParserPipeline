...
def init_pipeline(proj_home):
    ...
    schema = utils.get_schema(app, app.schema_client, app.config.get("PARSER_INPUT_SCHEMA"))
    ...
    consumer.subscribe([app.config.get("PARSER_INPUT_TOPIC", "PARSER")])
    ...
    app.logger.info("Starting PARSER APP")
...
class PARSER_APP:
    ...
    def parser_task(self, msg, producer):
        ...
        self.logger.debug(
            b"This message was generated by the parser and was read from the parser Input topic %s."
